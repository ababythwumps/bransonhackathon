...
export default function Chicago() {
    ...
    return (
        <div className={styles.container}>
            <Head>
                <title>Chicago Climate Forecast</title>
            ...
            <main className={styles.main}>
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className={styles.climateVisualization}>
                                ...
                                <p>See the impact of climate change on Chicago as time progresses</p>
                                
                                <div className={styles.gifContainer}>
                                    <div className={styles.gifCard}>
                                        <h3>Lake Michigan Levels</h3>
                                        <div className={styles.gifWrapper}>
                                            ...
                                            <div className={styles.gifPlayer} id="seaLevelGif">
                                                <img 
                                                    ...
                                                    alt="Lake Michigan level changes" 
                                        ...
                                        <p>Lake Michigan could see significant fluctuations in water levels due to climate change. Currently showing: {sliderYear}.</p>
                                    </div>
                                    ...
                                    <div className={styles.gifCard}>
                                        ...
                                        <p>Chicago is projected to experience more extreme weather events as climate change progresses. Year: {sliderYear}.</p>
                                    </div>
                ...
                <div className={styles.actionSection}>
                    <p>See how our actions today can impact Chicago's climate future.</p>
                    <Link href="/takeactionCH">
