...
const localActions = [
  // Transportation
  {
    ...
    recommendations: [
      ...
      'Take advantage of Chicago&apos;s walkable neighborhoods',
  ...
  // Diet and Food
  {
    ...
    recommendations: [
      ...
      'Try plant-based restaurants in Chicago',
  ...
  // Waste Management
  {
    ...
    recommendations: [
      ...
      'Shop at zero-waste stores in Chicago',
...
export default function ChicagoAction() {
  ...
  return (
    <>
      <Head>
        <title>Carbon Footprint Survey - Chicago</title>
        <meta name="description" content="Calculate your carbon footprint and find ways to reduce it in Chicago" />
        ...
        {currentStep === 0 && footprint === null && (
          <div style={{ 
            ...
            <p style={{ lineHeight: '1.6', maxWidth: '700px', margin: '1.5rem auto' }}>
              This 22-question survey will analyze your lifestyle across six key areas to estimate your carbon footprint and provide personalized recommendations for reducing your environmental impact in Chicago.
            </p>
            ...
            <p style={{ opacity: 0.7, fontSize: '0.9rem', maxWidth: '700px', margin: '1.5rem auto' }}>
              You can skip questions if they don&apos;t apply to you. Your results will include Chicago-specific recommendations based on your highest impact areas.
            </p>
