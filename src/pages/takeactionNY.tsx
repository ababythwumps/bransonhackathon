...
const TakeAction: React.FC = () => {
  return (
    <>
      <Head>
        <title>Take Action - New York Climate Change</title>
        <meta name="description" content="Take action against climate change in New York" />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: '1.6', opacity: '0.8' }}>
                Take our carbon footprint survey to understand your personal impact on climate change and get personalized recommendations for New York.
              </p>
            </div>
            <Link href="/action/NewYork">
              <button style={{
                padding: '16px 24px',
                backgroundColor: 'rgba(255, 255, 255, 0.1)',
                color: 'white',
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: '1.6', opacity: '0.8' }}>
                Connect with local organizations and community projects working to address climate change in New York.
              </p>
            </div>
            <a 
